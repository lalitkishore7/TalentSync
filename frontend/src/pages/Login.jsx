      ...
      >
        ...
        <div className="auth-form-container">
          ...
          <form className="auth-form" onSubmit={handleAuthSubmit}>
            ...
            {!isLogin && (
              <div className="form-row">
                <div className="input-group">
                  ...
                  <input type="text" className="auth-input" placeholder="e.g. John" />
                </div>
                <div className="input-group">
                  <label>Last Name</label>
                  <input type="text" className="auth-input" placeholder="e.g. Francisco" />
                </div>
              </div>
            )}
            ...
            <div className="input-group">
              <label>Email</label>
              <input type="email" className="auth-input" placeholder="e.g. johnfrans@gmail.com" />
            </div>
